        ...
        <div class="bg-[#F5F6FA] col-span-5">
            ...
            <div>
                ...
                <div class="flex justify-between p-3">
                    <p class="text-xl">Lista de Permisos</p>

                    <div class="items-center">
                        <p class="text-sm"> Home / Permisos </p>
                    </div>
                </div>
                        ...
                        <table class="my-5">
                            <thead>
                                <tr class="">
                                    ...
                                    <th class="border border-gray-300">Email / Usuario</th>
                                    <th class="border border-gray-300">Permisos</th>                                    
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td class="border border-gray-300 p-5 <?= $cambioColor ?>"><?= $permiso["id"] ?></td>
                                        <td class="border border-gray-300 p-2 <?= $cambioColor ?>"><?= $permiso["correo"] ?></td>
                                        <td class="border border-gray-300 p-2 <?= $cambioColor ?>"><?= $permiso["rol_id"] ?></td>                                                                                                                    
                                        <td class="border border-gray-300 py-5 flex <?= $cambioColor ?>">
                                            <a href="/permisos/edit" class=" mx-auto" >
