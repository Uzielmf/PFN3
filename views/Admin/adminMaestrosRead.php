            ...
            <div>
                ...
                <div class="bg-[#ffffff] shadow w-6/6 p-2 m-4 pl-5 text-gray-600">
                    <div class="flex justify-between border-b p-2">
                        ...
                        <form action="/maestros/form/create" method="post">
                        <button class="bg-blue-500 p-2 text-white rounded-lg">Agregar Maestros</button>
                        </form>
                    </div>
                        ...
                        <table class="my-5">
                            <thead>
                                <tr class="">
                                    ...
                                    <th class="px-4 border border-gray-300">Fec. de Nacimiento</th>
                                    <!-- <th class="px-4 border border-gray-300">Clase Asignada</th> -->
                            ...
                            <tbody>
                                ...
                                foreach ($maestrosData as $maestro) {
                                    if ($maestro["maestroID"] % 2 == 0) {
                                ...
                                ?>
                                    <tr>
                                        <td class="border border-gray-300 p-5 <?= $cambioColor ?>"><?= $maestro["maestroID"] ?></td>
                                        <td class="border border-gray-300 p-2 <?= $cambioColor ?>"><?= $maestro["nombre"] ?></td>
                                        <td class="border border-gray-300 p-2 <?= $cambioColor ?>"><?= $maestro["correo"] ?></td>
                                        <td class="border border-gray-300 p-2 <?= $cambioColor ?>"><?= $maestro["direccion"] ?></td>
                                        <td class="border border-gray-300 p-2 <?= $cambioColor ?>"><?= $maestro["fecha_nacimiento"] ?></td>
                                        <!-- <td class="border border-gray-300 p-2"> Aqui ira la clase asignada </td> -->
                                        <td class="border border-gray-300 py-5 flex <?= $cambioColor ?>">
                                            <a href="/maestros/edit" class="px-2" >
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                    <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                    <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z" />
                                                </svg> </a>
                                            <form action="/maestros/delete" method="post" class="inline">
                                            <input type="number" hidden  value="<?= $maestro["maestroID"] ?>" name="id">
