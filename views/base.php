    ...
    <div class="grid grid-cols-6 h-screen">
        ...
        <div class="bg-[#343A40] col-span-1 divide-y divide-solid">
            ...
            <div class="p-5 text-gray-400">
                <p class="text-lg py-2">Admin</p>
                <p>Administrador</p>
            </div>

            <div class="p-5 text-gray-400">
                <h2 class="text-sm text-center py-2">MENU ADMINISTRADOR</h2>
        ...
        <div class="bg-[#F5F6FA] col-span-5">
           ...
           <!-- aqui continuadra el codigo despues del include, recuerda cerrar dos div's al final con el body -->
